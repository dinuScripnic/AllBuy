...
class Ui_Form(object):
    def setupUi(self, Form, user):
        ...
        # self.quit_button.setGeometry(QtCore.QRect(430, 350, 93, 28))
        # font = QtGui.QFont()
        # font.setFamily("Times New Roman")
        # font.setPointSize(10)
        ...
        # self.password_button = QtWidgets.QPushButton(Form)
        # self.password_button.setGeometry(QtCore.QRect(290, 350, 130, 30))
        # self.password_button.setStyleSheet("background-color: rgb(208, 219, 189);")
        # font = QtGui.QFont()
        # font.setFamily("Times New Roman")
        # font.setPointSize(10)
    ...
    def retranslateUi(self, Form):
        ...
        # self.password_button.setText(_translate("Form", "Change Password"))
