...
class Ui_AllBuyCO(object):
    ...
    def user_functions(self):
        ...
        # if there is a user it opens the account widget with some information
            ...
            acc.quit_button.clicked.connect(self.quit_user)
            acc.change_password_button.clicked.connect(self.change_password)
            self.Form.show()
    ...
    def change_password(self):
        self.Form.close()
        if cpw.change_password(self.user):
            self.user = None
    ...
    def retranslateUi(self, AllBuyCO):
        ...
        self.large_phone.setText(_translate("AllBuyCO", ">6`"))
